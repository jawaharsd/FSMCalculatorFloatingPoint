...
public class MeasuredValueRecognizer {
	 ...
	 * @author Jawahar G 
	 * 
	 * @version 1.00       2018-02-20 added the remaining cases 5 to 7.
	 * 
	 */
	...
	public static String checkMeasureValue(String input) {
		...
		while (running) {
			...
			case 5: 
				// state 5 has two valid transitions
				finalState = false;
				//if current character is range from 1 to 9 then the state transitions to 7.
				if (currentChar >= '0' && currentChar <= '9') {
					nextState = 7;
					break;
				}
				// if current caracter is an '+' or '-', it transitions to state 6
			...
			case 6: 
				// state 6 has 1 valid transition 
				finalState = false;
				//if current character is range from 1 to 9 it transitions to state 7.
				if (currentChar >= '0' && currentChar <= '9') {
					nextState = 7;
					break;
				}
			...
			case 7: 
				...
				finalState = true;
				// if current character is range from 1 to 9 it transitions  again  to state 7 because it is the final state.
				if (currentChar >= '0' && currentChar <= '9') {
					nextState = 7;
					break;
				}
